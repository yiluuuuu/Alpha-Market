                        ...
                        <div className="px-4 pt-2 pb-6 space-y-1">
                            {navLinks.map((link) => (
                                <Link
                                    ...
                                    href={link.href}
                                    className={cn(
                                        "block px-4 py-3.5 text-base font-semibold rounded-xl transition-all",
                                        pathname === link.href
                            ...
                            {user ? (
                                ...
                                <div className="pt-4 border-t border-gray-50 space-y-2">
                                    <Link href="/auth/login" className="block px-4 py-3.5 text-base font-semibold text-gray-700 hover:bg-gray-50 rounded-xl text-center" onClick={() => setIsOpen(false)}>
                                        Login
                                    </Link>
                                    <Link href="/auth/register" className="block px-4 py-3.5 text-base font-semibold text-white bg-primary rounded-xl text-center" onClick={() => setIsOpen(false)}>
                                        Create Account
                                    </Link>
                                </div>
                            )}
