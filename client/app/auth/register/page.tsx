...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(`Welcome to Alpha Market, ${res.data.user.name}!`);
            router.push('/shop');
        } catch (err: any) {
        ...
        <div className="min-h-screen pt-20 flex items-center justify-center bg-gray-50 px-4">
            ...
            >
                <div className="text-center mb-10">
                    <h1 className="text-3xl font-black text-gray-900 tracking-tighter uppercase mb-2">Join the Elite</h1>
                    <p className="text-gray-500 font-medium italic">Create your Alpha Market account today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-4">Create Password</label>
                        <div className="relative">
                            <input
                                type="password"
                                required
